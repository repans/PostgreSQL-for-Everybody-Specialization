...
```
Load [this CSV data](https://www.pg4e.com/tools/sql/library.csv?PHPSESSID=6622aaf51e4ed12604d7624a70310610%22) file into the track_raw table using the \copy command. 
```
...
Now check if everything worked as epected: 
```
